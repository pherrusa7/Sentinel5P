...
def main():
    if not DEBUG:
        ...
        process(options.city, options.product, options.folder, options.folder_src, options.folder_grid)
    else:
...
if __name__ == "__main__":
    ...
    Calls that we used:
    python join_by_time.py -c Moscow -p L2__NO2___
    python join_by_time.py -c Moscow -p L2__O3____
    python join_by_time.py -c Moscow -p L2__SO2___
    python join_by_time.py -c Moscow -p L2__CO____
    python join_by_time.py -c Moscow -p L2__CH4___
    python join_by_time.py -c Moscow -p L2__HCHO__

    python join_by_time.py -c Istanbul -p L2__NO2___
    python join_by_time.py -c Istanbul -p L2__O3____
    python join_by_time.py -c Istanbul -p L2__SO2___
    python join_by_time.py -c Istanbul -p L2__CO____
    python join_by_time.py -c Istanbul -p L2__CH4___
    python join_by_time.py -c Istanbul -p L2__HCHO__

    python join_by_time.py -c Berlin -p L2__NO2___
    python join_by_time.py -c Berlin -p L2__O3____
    python join_by_time.py -c Berlin -p L2__SO2___
    python join_by_time.py -c Berlin -p L2__CO____
    python join_by_time.py -c Berlin -p L2__CH4___
    python join_by_time.py -c Berlin -p L2__HCHO__

    Problems:
    Moscow L2__CO____ has 0 days with values
    Moscow L2__HCHO__ has key error on attributes:
    'S5P_OFFL_L2__HCHO___20190821T092356_20190821T110525_09605_01_010107_20190827T135123.zip.incomplete'

    Istanbul/L2__CO____ has 0 days with values

    Berlin/L2__CO____ has 0 days with values
    """
